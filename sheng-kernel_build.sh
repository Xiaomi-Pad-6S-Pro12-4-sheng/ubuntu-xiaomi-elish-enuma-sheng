cd $1
git clone https://github.com/Xiaomi-Pad-6S-Pro12-4-sheng/sm8550-mainline --depth 1 linux --branch sheng-$2-rc2
cd linux
...
$1/mkbootimg --kernel zImage_sheng --cmdline "root=PARTLABEL=userdata" --base 0x00000000 --kernel_offset 0x00008000 --tags_offset 0x01e00000 --pagesize 4096 --id -o $1/boot_sheng.img
